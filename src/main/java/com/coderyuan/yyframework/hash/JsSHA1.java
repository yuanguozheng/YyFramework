 ...
 * You can call each one of the 6 work methods by using something like: JsSHA1.hex_hmac_sha1("key", "data");
...
/**
 * Calculate the HMAC-JsSHA1 of a key and some data
 * Creation date: (3/26/2004 1:05:01 PM)
 * @author T.N.Silverman
 * @version 1.0.0
 * @return int
